/*
Declare
    @PsTabla                   Sysname       = 'segAutOperacionesTbl',
    @PsColumna                 Sysname       = 'idAutorizacion',
    @PnValor                   Smallint      = 1,
    @PsDescripcion             Varchar(  60) = 'Permisos de Alta',
    @PnIdOperacion             Integer       = 4,
    @PnIdUsuarioAct            Integer       = 1,
    @PnEstatus                 Integer       = 0,
    @PsMensaje                 Varchar( 250) = ' '
Begin
   Execute dbo.Spa_catGeneralesTbl @PsTabla        = @PsTabla,
                                   @PsColumna      = @PsColumna,
                                   @PnValor        = @PnValor,
...
Create Or Alter Procedure dbo.Spa_catGeneralesTbl
   (@PsTabla                   Sysname,
    @PsColumna                 Sysname,
    @PnValor                   Smallint,
